 ...
 * deseja com base em um operador informado pelo usuário.</p>
 ...
 * <li>Aplicações de refatoração em código Java</li>
 * <li> Documentação com Javadoc</li>
 * 
 * </ul>
 * <p>Após a refatoração, os métodos desta classe são <strongmétodos puros</strong>,
...
<p>Executa a operação matemática solicitada com base no operador informade
*
...
@throws IllegalArgumentsException se o operador não for um símbolo válido
 */
